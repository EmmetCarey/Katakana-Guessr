...
struct LevelsViewTest: View {
    
    @Binding var isKat : Bool
    
    @State private var nextPage : Bool = false
    @State private var isResetKat : Bool  = false
    @State private var isResetHir : Bool  = false
    ...
    @State private var isGoText : Bool = false
    ...
    struct LevelsView_Previews: PreviewProvider {
        static var previews: some View {
            LevelsViewTest(isKat: .constant(true))
        }
    }
}
